...
class Basic():
    ...
    @pytest.mark.splunk_addon_searchtime
    def test_requirement(self,splunk_search_util,splunk_searchtime_cim_reqs,caplog):
        """
        ...
        """
        list_nodes = []
        file_name = splunk_searchtime_cim_reqs
    ...
    #     self.logger.info(splunk_searchtime_cim_reqs)
    #     self.logger.info("Hi")
    #     assert True
